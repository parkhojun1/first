...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("input:radio[name=birthlunar]:radio[value='${data.BIRTHLUNAR}']").prop("checked","true");
		$("input:radio[name=gender]:radio[value='${data.GENDER}']").prop("checked","true");
		$("input:radio[name=jointype]:radio[value='${data.JOINTYPE}']").prop("checked","true");
		$("input:radio[name=marry]:radio[value='${data.MARRY}']").prop("checked","true");
		$("select[name=paytype]").val("${data.PAYTYPE}");
		$("select[name=hopejob]").val("${data.HOPEJOB}");
		$("select[name=jointype]").val("${data.JOINTYPE}");
		
		if("${data.IMGLOCAL}" ==''){
			$(".box").html('<img style="height: 110; width: 100" id="preview"></img>');
		}else{
			$(".box").html('<img style="height: 110; width: 100" id="preview" src="http://localhost:8080/resources/upload/${data.IMGLOCAL}"></img>')
		}
	...
	function insertUpload(){
	    ...
	    $.ajax({
	        ...
	        url : "/modifyAjax",      // 컨트롤러에서 대기중인 URL 주소이다.
	        data : params, 
...
<body topmargin="0" leftmargin="0">
	<form action="#" id="fileForm" enctype="multipart/form-data" style="display:none;" method="post">
	...
	<form action="#" id="insertForm">
		<input type="hidden" name="indexno" value="${data.INDEXNO}">
		<input type="hidden" name="imglocal" value="${data.IMGLOCAL}">
		<input type="hidden" name="excellocal" value="${data.EXCELLOCAL}" >
		<input type="hidden" name="wordlocal"  value="${data.WORDLOCAL}">
																		...
																		<tr>
																			<td height="112" bgcolor="#CCCCCC"><table
																					...
																					<tr>
																						...
																						<div class="box"><img
																							style="height: 110; width: 100" id="preview"></img></div></td>
																					</tr>
																				</table></td>
																		</tr>
																	</table></td>
																<td width="456"><table width="423" border="0"
																		...
																		<tr>
																			...
																			<td width="310" height="26"><input type="text"
																				name="korname"  value="${data.KORNAME}" onkeyup="kor()"><span style="color:red"></span></td>
																		</tr>
																		<tr>
																			<td height="26" align="right"><strong>영문이름
																					:&nbsp;</strong></td>
																			<td height="26"><input type="text"
																				name="engname" value="${data.ENGNAME}"></td>
																		</tr>
																		<tr>
																			<td height="26" align="right"><strong>한문이름:</strong>&nbsp;</td>
																			<td height="26"><input type="text"
																				name="chnname" value="${data.CHNNAME}"></td>
																		</tr>
																		<tr>
																			<td height="26" align="right"><strong>주민등록번호
																					:</strong>&nbsp;</td>
																			<td height="26"><input name="resno1" value="${data.RESNO1}" type="text"
																			onkeyup="birth()"	size="15"> - <input name="resno2" value="${data.RESNO2}"
													...
													<td bgcolor="#E4EBF1"><table width="526" border="0"
															...
															<tr>
																<td width="102" align="right"><strong>사진파일명
																		:&nbsp;</strong></td>
																<td width="268"><input name="imgname" type="text" value="${data.IMGNAME}"
																	size="40"></td>
													...
													<td bgcolor="#E4EBF1"><table width="526" border="0"
															...
															<tr>
																<td width="102" align="right"><strong>엑셀파일명
																		:&nbsp;</strong></td>
																<td width="268"><input name="excelname" type="text" value="${data.EXCELNAME}"
																	size="40"></td>
																<td width="146"><font color="#FF0000"><img
																		src="resources/image/bt_search.gif"
													...
													<td bgcolor="#E4EBF1"><table width="526" border="0"
															...
															<tr>
																<td width="102" align="right"><strong>워드파일명
																		:&nbsp;</strong></td>
																<td width="268"><input name="wordname" type="text" value="${data.WORDNAME}"
																	size="40"></td>
																<td width="146"><font color="#FF0000"><img
																		src="resources/image/bt_search.gif"
													...
													<td bgcolor="#E4EBF1"><table width="500" border="0"
															...
															<tr>
																<td width="102" align="right"><strong>생년월일
																		:&nbsp;</strong></td>
																<td width="391"><input name="birth1" type="text" value="${data.BIRTH1}"
																	size="10"> 년 <input name="birth2" type="text" value="${data.BIRTH2}"
																	size="7"> 월 <input name="birth3" type="text" value="${data.BIRTH3}"
													...
													<td bgcolor="#E4EBF1"><table width="500" border="0"
															...
															<tr>
																<td width="101" align="right"><strong>년차
																		:&nbsp;</strong></td>
																<td width="392"><input name="year" type="text" value="${data.YEAR}"
																	size="10"></td>
															</tr>
														</table></td>
												</tr>
												...
												<tr>
													<td bgcolor="#E4EBF1"><table width="500" border="0"
															...
															<tr>
																...
																<td width="392"><input name="address1" type="text" value="${data.ADDRESS1}"
																	size="10"> <input name="address2" type="text" value="${data.ADDRESS2}"
																	size="40"></td>
															</tr>
														</table></td>
												</tr>
												<tr>
													<td bgcolor="#E4EBF1"><table width="500" border="0"
															...
															<tr>
																...
																<td width="392"><input name="phoneno1" type="text" value="${data.PHONENO1}"
																	size="10"> - <input name="phoneno2" type="text" value="${data.PHONENO2}"
																	size="10"> - <input name="phoneno3" type="text" value="${data.PHONENO3 }"
																	size="10"></td>
															</tr>
														</table></td>
												</tr>
												<tr>
													<td bgcolor="#E4EBF1"><table width="500" border="0"
															...
															<tr>
																...
																<td width="392"><input name="email" type="text" value="${data.EMAIL}"
																	size="20"></td>
															</tr>
														</table></td>
												</tr>
												<tr>
													<td bgcolor="#E4EBF1"><table width="500" border="0"
															...
															<tr>
																...
																<td width="392"><input name="grade" type="text" value="${data.GRADE}"
																	size="20"></td>
															</tr>
														</table></td>
												</tr>
												<tr>
													<td bgcolor="#E4EBF1"><table width="500" border="0"
															...
															<tr>
																...
																<td width="392"><input name="hoff" type="text" value="${data.HOFF}"
																	size="20"></td>
															</tr>
														</table></td>
												</tr>
